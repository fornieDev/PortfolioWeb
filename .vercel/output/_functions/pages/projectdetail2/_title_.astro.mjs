...
const $$title = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Project Detail" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h1>Project Detail</h1> <div class="center vertical"> ${Projects.filter((project) => project.title === title).map(
...
}, "/home/javi/Escritorio/RepositoriosVSCode/PortfolioWeb/src/pages/projectDetail2/[title].astro", void 0);

const $$file = "/home/javi/Escritorio/RepositoriosVSCode/PortfolioWeb/src/pages/projectDetail2/[title].astro";
const $$url = "/projectDetail2/[title]";
